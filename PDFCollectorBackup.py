...
def extract_text_from_compact_file(file_path, poppler_path='poppler-24.08.0\\Library\\bin', dpi=300):       # Esta dentro de process_pdfs_compressed
...
def correct_skew(image):                                                                                    # Esta dentro de extract_text_from_compact_file
...
def process_pdfs_compressed(extract_path):                              # Script unico
